...
const WorkCard: React.FC<WorkCardProps> = ({ work }) => {
  return (
    <div className="watercolor-card group bg-paper rounded-2xl overflow-hidden shadow-watercolor transition-all duration-500 ease-out hover:shadow-watercolor-hover">
