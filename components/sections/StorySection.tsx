    ...
    <section id="story">
        <Layout>
          <div className="max-w-3xl mx-auto">
            <ScrollReveal>
              <h2 className="text-4xl font-serif-jp font-bold text-center text-ink mb-6"><span className="brush-underline">僕が挑戦の道を歩む理由</span></h2>
              <p className="text-center text-ink/80 mb-16 leading-relaxed">
                これは、特別な才能もなかった一人の男が、絶望の淵から「挑戦」という光を見つけ、<br />息子の未来と自分自身の希望のために、再び歩き出すまでの物語です。
              </p>
            </ScrollReveal>
