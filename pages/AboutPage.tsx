  ...
  return (
    <Layout>
      <div className="max-w-3xl mx-auto">
        <ScrollReveal>
          <h2 className="text-4xl font-serif-jp font-bold text-center text-ink mb-6"><span className="brush-underline">僕が創造の道を歩む理由</span></h2>
          <p className="text-center text-ink/80 mb-16 leading-relaxed">
            これは、特別な才能もなかった一人の男が、絶望の淵から「創造」という光を見つけ、<br />息子の未来と自分自身の希望のために、再び歩き出すまでの物語です。
          </p>
        </ScrollReveal>
        ...
        <div className="space-y-16 text-ink/90 leading-loose text-base">
          <ScrollReveal delay={100}>
            <section>
              ...
              <p className="mb-4">
                油の匂いと絶え間ない機械の轟音が支配する工場。三交替勤務の不規則なリズムの中、僕はそんな風に自分を納得させながら、ただ時間をやり過ごしていました。Fランク大学を１浪して卒業し、特別なスキルもない僕にとっては、それが分相応の人生だと、いつしか思い込んでいたのです。
              </p>
              <p className="mb-4">
              ...
              <h4 className="text-xl font-serif-jp font-bold text-ink mb-4">先の見えない道</h4>
               <figure className="my-12">
                 <img src="https://images.unsplash.com/photo-1484820038232-a5b65b4c139c?auto=format&fit=crop&w=800&q=80" alt="先の見えない道" className="w-full rounded-2xl shadow-watercolor" />
          ...
          <ScrollReveal delay={200}>
           ...
           <ScrollReveal delay={200}>
            <section>
              ...
              <p className="mb-4">
                しかし、僕が希望の船に乗り少しずつ成長を自覚できてきた矢先、その船は大きな嵐に見舞われます。
              </p>
              <blockquote className="relative bg-transparent p-6 my-8 text-sm text-ink/80">
                ...
                <div className="relative">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                   ...
                   <cite className="block text-right mt-4 not-italic">- 2025年7月 マナブさんからの発表より抜粋</cite>
                </div>
              </blockquote>
              <p className="mb-4">
              ...
              <p>
                なぜなら、僕の決意はもう誰かや何かに依存するものではなくなっていたからです。「環境が変わっても、自分の足で立つしかない。BGLが結果を出すために変わるのなら、僕も個人として結果を出す」。むしろこの出来事は僕の覚悟を固めるための最初の試練となりました。
              </p>
            </section>
          </ScrollReveal>
          ...
          <ScrollReveal delay={200}>
            <section>
              ...
              <h4 className="text-xl font-serif-jp font-bold text-ink mb-4">子供との未来</h4>
              <figure className="my-12">
                 <img src="https://images.unsplash.com/photo-1503435824048-a799a3a82678?auto=format&fit=crop&w=800&q=80" alt="子供との未来" className="w-full rounded-2xl shadow-watercolor" />
              ...
              <p className="mb-4">
               ...
               <p className="font-bold text-center text-lg my-8 font-serif-jp">
                BGLに出会い、挑戦という希望に触れ、僕は救われました。まだ形に残る成果は小さいですが、ドン底から這い上がる活力と勇気をいただきました。この物語が、今、かつての僕と同じように暗闇の中にいる誰かの、小さな灯火になることを願って。
              </p>
            </section>
          </ScrollReveal>
